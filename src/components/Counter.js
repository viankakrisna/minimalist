...
import { increment, decrement, asyncDecrement, asyncIncrement } from '../lib/mutators';
...
const Counter = props => div(
  ...
  div(
    ...
    e(Button, { bg: colors.blue.shade_700, onClick: e => setState(increment(1)) }, 'Increment'),
    e(Button, { bg: colors.red.shade_700, onClick: e => setState(decrement(1)) }, 'Decrement'),
    br(),
    e(
      Button,
      {
